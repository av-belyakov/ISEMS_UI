                            ...
                            <Form validated>
                                <Row>
                                    <Form.Check 
                                        ...
                                        className="ml-3" 
                                        name="task_checkbox"/>
                                    <small className="ml-1 mt-n1 mr-4">задача</small>
                                    <Form.Check 
                                        type="radio"
                                    ...
                                    <small className="ml-1 mt-n1 mr-4">закрыта</small>
                                    <Form.Check 
                                        type="radio"
                                        onClick={this.handlerRadioChosen}  
                                        ...
                                        defaultChecked
                                        disabled={this.state.disabledRadioChosenTask} />
                                    <small className="ml-1 mt-n1">открыта</small>
                                </Row>
                            </Form>
                        </Col>
                    </Row>
                    <Row className="ml-3 mt-3">
                        <Col md={4}>
                            <Row className="ml-1 mt-n1">
                                <Form.Check className="mt-1" type="checkbox" onClick={this.handlerCheckbox} name="files_found" />
                                <small className="ml-1">файлы найдены</small>
                            </Row>
                            <Row className="ml-1 mt-n1">
                                <Form.Check className="mt-1" type="checkbox" onClick={this.handlerCheckbox} name="file_uploaded_check"/>
                                <small className="ml-1 mr-3">выгрузка выполнялась</small>
                                <Form.Check 
                                    type="radio"
                                    onClick={this.handlerRadioChosen} 
                                    id="r_upload_file" 
                                ...
                                <small className="ml-1 mr-3">да</small>
                                <Form.Check 
                                    type="radio"
                                    onClick={this.handlerRadioChosen} 
                            ...
                            <Row className="ml-1 mt-n2">
                                <Form.Check className="mt-1" type="checkbox" onClick={this.handlerCheckbox} name="all_file_uploaded_check"/>
                                <small className="ml-1 mr-3">все файлы выгружены</small>
                                <Form.Check 
                                    type="radio"
                                    onClick={this.handlerRadioChosen} 
