    ...
    return (<Dialog 
        ...
        <DialogTitle>
            <Grid container direction="row" spacing={3}>
                <Grid item container md={11}><span className="pt-2">Удаление <span className="text-muted">{objectsId[1]}</span></span></Grid>
        ...
        <DialogContent>
            <Grid container direction="row" spacing={3}>
                <Grid item container md={12} style={{ display: "block" }}>
                    Вы действительно хотите удалить ссылку <strong className="text-muted">{objectsId[1]}</strong> из <strong className="text-muted">{objectsId[0]}</strong>?
                </Grid>
            </Grid>            
        </DialogContent>
        <DialogActions>
