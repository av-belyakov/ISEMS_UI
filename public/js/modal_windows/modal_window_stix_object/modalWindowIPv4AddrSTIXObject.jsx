...
export default function CreateModalWindowIPv4AddrSTIXObject(props){
    ...
    if((listObjectInfo[currentIdSTIXObject] === null) || (typeof listObjectInfo[currentIdSTIXObject] === "undefined")){
        return (<React.Fragment>
            ...
            Просмотр и редактирование STIX объекта типа IP адрес версии 4 (IPv4 address CO STIX)
                </Col>
            </Row>
        </React.Fragment>);
    }
...
CreateModalWindowIPv4AddrSTIXObject.propTypes = {
