...
export default function CreateModalWindowX509CertificateSTIXObject(props){
    ...
    if((listObjectInfo[currentIdSTIXObject] === null) || (typeof listObjectInfo[currentIdSTIXObject] === "undefined")){
        return (<React.Fragment>
            ...
            Просмотр и редактирование STIX объекта типа x509 сертификат (x509 certificate CO STIX)
                </Col>
            </Row>
        </React.Fragment>);
    }
...
CreateModalWindowX509CertificateSTIXObject.propTypes = {
