...
export default function CreateModalWindowIntrusionSetSTIXObject(props){
    ...
    if((listObjectInfo[currentIdSTIXObject] === null) || (typeof listObjectInfo[currentIdSTIXObject] === "undefined")){
        return (<React.Fragment>
            ...
            Просмотр и редактирование STIX объекта типа Набор вторжения (Intrusion Set DO STIX)
                </Col>
            </Row>
        </React.Fragment>);
    }
...
CreateModalWindowIntrusionSetSTIXObject.propTypes = {
