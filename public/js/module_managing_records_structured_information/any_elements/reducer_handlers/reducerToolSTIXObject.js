export default function reducerToolSTIXObjects(state, action){
    switch(action.type){
    case "newAll":
        return action.data;
    case "cleanAll":
    ...
    case "updateToolTypes":
        return {...state, tool_types: action.data};
    ...
    case "updateKillChainPhases":
        ...
        return {...state};
    case "updateToolVersion":
        return {...state, tool_version: action.data};
