...
import CreateWindowsRegistryKeyPatternElements from "./windowsRegistryKeyPatternElements.jsx";
        ...
        return (<DialogContent>
            <Grid container direction="row" spacing={3}>
                <Grid item container md={12} justifyContent="center" className="pb-3">
                    поиск информации об STIX объекте типа Раздел реестра Windows (Windows registry key CO STIX)
                </Grid>
            </Grid>
            <LinearProgress />
        </DialogContent>);
