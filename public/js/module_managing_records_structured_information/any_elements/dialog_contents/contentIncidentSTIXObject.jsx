...
export default function CreateDialogContentIncidentSTIXObject(props){
    let { 
        listObjectInfo, 
        currentIdSTIXObject,
        handlerDialog,
        ...
        return (<DialogContent>
            <Grid container direction="row" spacing={3}>
                <Grid item container md={12} justifyContent="center" className="pb-3">
                    поиск информации об STIX объекте типа Инцидент (Incident DO STIX)
                </Grid>
            </Grid>
            <LinearProgress />
        </DialogContent>);
        ...
        <DialogContent>
            <Row className="mt-2">
                <Col md={12} className="pl-3 pr-3">
                    Просмотр и редактирование STIX объекта типа Инцидент (Incident DO STIX)
                </Col>
...
CreateDialogContentIncidentSTIXObject.propTypes = {
