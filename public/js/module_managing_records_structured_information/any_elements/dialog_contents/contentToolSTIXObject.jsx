...
import CreateToolPatternElements from "../type_elements_stix/toolPatternElements.jsx";
        ...
        return (<DialogContent>
            <Grid container direction="row" spacing={3}>
                <Grid item container md={12} justifyContent="center" className="pb-3">
                    поиск информации об STIX объекте типа Инструмент (Tool DO STIX)
                </Grid>
            </Grid>
            <LinearProgress />
        </DialogContent>);
    ...
    return (<React.Fragment>
        <DialogContent>
            <Row className="mt-2">
                ...
                Просмотр и редактирование STIX объекта типа Инструмент (Tool DO STIX)
                </Col>
