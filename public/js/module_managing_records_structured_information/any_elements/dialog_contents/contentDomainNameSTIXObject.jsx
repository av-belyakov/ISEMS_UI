...
import CreateDomainNamePatternElements from "./domainNamePatternElements.jsx";
...
export default function CreateDialogContentDomainNameSTIXObject(props){
        ...
        return (<DialogContent>
            <Grid container direction="row" spacing={3}>
                <Grid item container md={12} justifyContent="center" className="pb-3">
                        поиск информации об STIX объекте типа Доменное имя (Domain name CO STIX)
                </Grid>
            </Grid>
            <LinearProgress />
        </DialogContent>);
    ...
    return (<React.Fragment>
        <Row className="mt-2">
            ...
            Просмотр и редактирование STIX объекта типа Доменное имя (Domain name CO STIX)
            </Col>
