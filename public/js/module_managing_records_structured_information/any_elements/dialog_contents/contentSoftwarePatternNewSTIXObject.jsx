...
export default function CreateSoftwarePatternNewSTIXObject(props){
    let { 
        isNotDisabled,
        buttonAddClick,
        buttonChangeClick,
...
CreateSoftwarePatternNewSTIXObject.propTypes = {
...
function CreateMajorElements(props){
    ...
    /**
 * 
 * Надо выполнить отладку, возникают какие то ошибки
 * 
 */
    ...
    useEffect(() => {
        if(projectPatterElement.type === "software"){
            ...
            <Grid container direction="row">
                <Grid item container md={8} justifyContent="flex-start">
                    <Typography variant="overline" display="block" gutterBottom>
                        {`${helpers.getLinkImageSTIXObject("software").description}`}
                    </Typography> 
                </Grid>
            </Grid>
