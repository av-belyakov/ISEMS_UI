...
import CreateEmailAddressPatternElements from "../type_elements_stix/emailAddressPatternElements.jsx";
...
export default function CreateDialogContentEmailAddrSTIXObject(props){
        ...
        return (<DialogContent>
            <Grid container direction="row" spacing={3}>
                <Grid item container md={12} justifyContent="center" className="pb-3">
                        поиск информации об STIX объекте типа Email адрес (Email address CO STIX)
                </Grid>
            </Grid>
            <LinearProgress />
        </DialogContent>);
    ...
    return (<React.Fragment>
        ...
        Просмотр и редактирование STIX объекта типа Email адрес (Email address CO STIX)
                </Col>
