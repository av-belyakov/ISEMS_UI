...
import CreateProcessPatternElements from "./processPatternElements.jsx";
...
export default function CreateDialogContentProcessSTIXObject(props){
        ...
        return (<DialogContent>
            <Grid container direction="row" spacing={3}>
                <Grid item container md={12} justifyContent="center" className="pb-3">
                    поиск информации об STIX объекте типа Процесс (Process СO STIX)
                </Grid>
            </Grid>
            <LinearProgress />
        </DialogContent>);
    ...
    return (<React.Fragment>
        ...
        Просмотр и редактирование STIX объекта типа Процесс (Process СO STIX)
                </Col>
