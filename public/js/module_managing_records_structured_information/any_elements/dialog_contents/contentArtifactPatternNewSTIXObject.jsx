...
function CreateMajorElements(props){
    ...
    console.log("func 'CreateDialogContentArtifactPatternNewSTIXObject', buttonAddClick:", buttonAddClick, " buttonChangeClick:", buttonChangeClick);

    let currentObjectId = React.useMemo(() => {
        return `artifact--${uuidv4()}`;
